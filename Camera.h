...
public:
	...
	void UpdateRail(double dt); // Update a camera on rails (movement along a specific axis)
	...
	void MovementRail(double dt); // Move rail camera position and view based on key presses 
