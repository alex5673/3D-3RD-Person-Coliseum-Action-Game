...
bool CSkybox::Create(const char *bmpDirectory, const float fSize)
{
	...
	texture.Load("Resources\\Textures\\GreyCloudBack.bmp", true);
	m_textureIDs[SKYBOX_BACK_ID] = texture.m_textureID;

	texture.Load("Resources\\Textures\\GreyCloudFront.bmp", true);
	m_textureIDs[SKYBOX_FRONT_ID] = texture.m_textureID;

	texture.Load("Resources\\Textures\\GreyCloudBottom.bmp", true);
	m_textureIDs[SKYBOX_BOTTOM_ID] = texture.m_textureID;

	texture.Load("Resources\\Textures\\GreyCloudTop.bmp", true);
	m_textureIDs[SKYBOX_TOP_ID] = texture.m_textureID;

	texture.Load("Resources\\Textures\\GreyCloudLeft.bmp", true);
	m_textureIDs[SKYBOX_LEFT_ID] = texture.m_textureID;

	texture.Load("Resources\\Textures\\GreyCloudRight.bmp", true);
